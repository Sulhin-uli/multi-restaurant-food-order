                            ...
                            @foreach ($city as $key => $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('delete.city', $item->id) }}" id="delete" class="btn btn-danger waves-effect waves-light">Delete</a>
                                    </td> 
                                </tr> 
...
<div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="myForm" method="POST" action="{{ route('city.store') }}" enctype="multipart/form-data">
                @csrf
...
<div id="myEdit" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="myForm" method="POST" action="{{ route('city.update') }}" enctype="multipart/form-data">
                @csrf
