                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="cover_photo" type="file" id="image_cover">
                                    </div>    
                                    <img id="showImageCover" src="{{ !empty($profileData->cover_photo) ? url('upload/client_images/' . $profileData->cover_photo) : url('upload/no_image.jpg') }}" alt="" class="p-1 bg-primary" width="210" height="100">
                                </div>
                            </div>
